...
class Mailchimp_Campaigns
{
	 ...
	 */
	public function content($cid, $options=[])
	{
	 ...
	 */
	public function getList($filters=[], $start=0, $limit=25, $sort_field='create_time', $sort_dir='DESC')
	{
	 ...
	 *     - complete bool whether the call worked. reallistically this will always be true as errors will be thrown otherwise.
	 */
	public function sendTest($cid, $test_emails=[], $send_type='html')
	{
