	...
	<main>
		<header>
			<section>
				...
				<h3 class="featured">[DATE]<br>Lighthouse, Kensington Street, Brighton, BN1 4AJ</h3>
		...
		<section>
			...
			<div class="intro">
				<p>Bytes is a web-industry focused mini-conference to be held at <b>Lighthouse</b>, a hub for creative industries in the centre of Brighton on <b>[ENTER DATE]</b></p>
